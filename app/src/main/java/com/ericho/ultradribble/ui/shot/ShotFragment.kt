...
import com.ericho.ultradribble.extension.loadHighQualityWithPalette
import com.ericho.ultradribble.glide.OnPaletteProcessingCallback
import com.ericho.ultradribble.ui.shot.comments.CommentsActivity
import com.ericho.ultradribble.ui.shot.comments.CommentsPresenter
import com.ericho.ultradribble.ui.shot.likes.LikesActivity
import com.ericho.ultradribble.ui.shot.likes.LikesPresenter
...
class ShotFragment : Fragment(), ShotContract.View {
    ...
    override fun show(shot: Shot) {
        ...
        shot_image_view.loadHighQualityWithPalette(shot.images.best(), object : OnPaletteProcessingCallback {
        ...
        avatar.loadAvatar(shot.user?.avatarUrl!!)
